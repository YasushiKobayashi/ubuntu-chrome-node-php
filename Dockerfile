...
# install php
RUN apt-get update && \
  apt-get install -y php7.0-fpm php7.0-cli php7.0-curl php7.0-gd php7.0-intl php7.0-pgsql php7.0-mbstring php7.0-pdo php7.0-gd php7.0-mysqlnd php7.0-mcrypt php7.0-zip && \
